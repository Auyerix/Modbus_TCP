...
/*Function to perform reading using SWO and Serial Wire Viewer (SWV) to send simple text by GA*/
/* Instrumentation Trace Macrocell (ITM)*/
void Task_action(char message);

/* Function to send a string via ITM add by GA*/
/* Instrumentation Trace Macrocell (ITM)*/
